    ...
    getUserDBInfo()
      .then((data) => {
        ...
        if (found) {
          ...
          if (favorito === true) {
            let fav_arr = data.data().favoritos;
            let new_fav_arr = [...fav_arr, review_obj];
            addJogosFavoritos(new_fav_arr);
          }
  ...
  const filterArrayWithPreviewReview = () => {
    getUserDBInfo()
      .then((data) => {
        ...
        //favorites to user profile db
        let previews_favorites = data.data().favoritos;
        let filtered_previews_arr = previews_favorites.filter((item) => {
          return item.selectedGame !== exportedObj.selectedGame;
        });
        let new_arr_fitlered_favorites = [
          ...filtered_previews_arr,
          exportedObj,
        ];
        addJogosFavoritos(new_arr_fitlered_favorites);
          ...
          <div className="post-side-container review-post-side">
            ...
            <div className="checkbox-container text-area-container review-area-container">
              ...
              <div className="checkbox-wrapper-1">
                ...
                />
                <label htmlFor="example-2">Favorito</label>
              </div>
            </div>
            <div>
              <div>
